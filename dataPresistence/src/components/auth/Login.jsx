        ...
        <div className='border-2 rounded-xl border-emerald-600 p-20'>
            <form onSubmit={(e) => {
             ...
             className='flex flex-col items-center justify-center'>
                ...
                className='outline-none bg-transparent border-2 border-emerald-600 font-medium text-lg py-2 px-6 rounded-full placeholder:text-gray-400' type="email" placeholder='Entere Your Email' />
                <input required  
                value={password}
                onChange={(e)=> {
